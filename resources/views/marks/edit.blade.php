                            ...
                            @foreach($students as $s)
                                @if($s->id == $user_id)
                                    <tr>
                                        ...
                                        <td>{{$s->name}}</td>
                                        <td>{{$s->surname}}</td>
                                        {!!Form::open(['action' => ['MarksController@update', $mark->id], 'method'=>'POST'])!!}
                                            <td>{!!Form::text('notes', $mark->notes,['class' => 'form-control', 'placeholder' => 'Notes']) !!}</td>
                                            <td>{!!Form::number('value', $mark->value,['class' => 'form-control', 'placeholder' => 'Value']) !!}</td>
                                ...
                                @else
                                    <tr>
                                        ...
                                        <td>{{$value}}</td>
                                        <td>
                                            <a class="btn text-dark" role="button" href="/marks/{{$lesson->id}}/{{$s->id}}" style="height: 40px;">
